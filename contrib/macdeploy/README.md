...
When complete, it will have produced `Devcoin-Core.dmg`.
...
apt install cpio
git clone https://github.com/devcoin-core/apple-sdk-tools.git
...
- The Apple keyholder uses this unsigned app to create a detached signature, using the
  script that is also included there. Detached signatures are available from this [repository](https://github.com/devcoin-core/devcoin-detached-sigs).
