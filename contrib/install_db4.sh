...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the devcoin repository."
  exit 1
fi
...
# See https://github.com/devcoin/core/issues/16064
...
echo 'When compiling devcoind, run `./configure` in the following way:'
echo
