...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef DEVCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define DEVCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the devcoin network\n')
    ...
    g.write('#endif // DEVCOIN_CHAINPARAMSSEEDS_H\n')
