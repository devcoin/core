...
def main():
    ...
    # Filter out hosts with multiple devcoin ports, these are likely abusive
    ips = filtermultiport(ips)
    print('%s Filter out hosts with multiple devcoin ports' % (ip_stats(ips)), file=sys.stderr)
