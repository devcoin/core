...
(define* (make-devcoin-cross-toolchain target
                                       #:key
...
desirable for building Devcoin Core release binaries."
...
(define glibc-2.27/devcoin-patched
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list (cond ((string-contains target "riscv64-")
                        (make-devcoin-cross-toolchain target
                                                      #:base-libc glibc-2.27/devcoin-patched
