...
devcoin.org and devcoin.org and compares them.
...
WORKINGDIR = "/tmp/devcoin_verify_binaries"
HASHFILE = "hashes.tmp"
HOST1 = "https://devcoin.org"
HOST2 = "https://devcoin.org"
VERSIONPREFIX = "devcoin-core-"
...
def main(args):
    ...
    if not success:
        print("devcoin.org failed to provide signature file, "
              "but devcoin.org did?")
        print("wget output:")
        print(indent(output, '\t'))
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("devcoin.org and devcoin.org signature files were not equal?")
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the Devcoin Core binary release "
