...
This document provides guidelines for internationalization of the Devcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `devcoin_en.ts` remains unchanged.
