Devcoin Core version 0.13.2 is now available from:
  ...
  <https://devcoin.org/bin/devcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update devcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow devcoin-tx to create v2 transactions (btcdrak)
