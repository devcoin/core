Devcoin Core version 0.9.2.1 is now available from:

  https://devcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 DVC to 0.01 DVC
...
- Fix "Start devcoin on system login"
