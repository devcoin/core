Devcoin Core version 0.10.4 is now available from:

  <https://devcoin.org/bin/devcoin-core-0.10.4/>
...
- #6953 `43c2789` Split devcoin-tx into its own package
- #6953 `dfe0d4d` Include devcoin-tx binary on Debian/Ubuntu
