Devcoin Core version 0.9.4 is now available from:

  https://devcoin.org/bin/0.9.4/
...
this update is incompatible with the Devcoin system and could lead to consensus
forks.

Devcoin Core released binaries from https://devcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~devcoin/+archive/ubuntu/devcoin
- A third-party or self-compiled Devcoin Core

upgrade to Devcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
