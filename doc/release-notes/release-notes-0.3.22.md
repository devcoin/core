Download URL: https://sourceforge.net/projects/devcoin/files/Devcoin/devcoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 DVC fee schedule (users still pay 0.01 DVC per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #devcoin00 - #devcoin99
