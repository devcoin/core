...
Devcoin Core version 0.19.1 is now available from:

  <https://devcoin.org/bin/devcoin-core-0.19.1/>
...
From Devcoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Devcoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Devcoin Core does not yet change appearance when
...
- #17488 fix "devcoind already running" warnings on macOS (fanquake)
