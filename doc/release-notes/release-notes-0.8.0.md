Devcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/devcoin/files/Devcoin/devcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Devcoin
...
New/changed settings (command-line or devcoin.conf file)
--------------------------------------------------------
