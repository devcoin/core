Devcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/devcoin/files/Devcoin/devcoin-0.5.4/
...
http://gitorious.org/devcoin/devcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Devcoin-Qt notifications under Growl 1.3.
Increase required age of Devcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxDevcoin properly when installing Devcoin-Qt over it. (Windows)
