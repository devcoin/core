Devcoin Core version *0.15.2* is now available from:

  <https://devcoin.org/bin/devcoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in devcoin-tx (TheBlueMatt)
