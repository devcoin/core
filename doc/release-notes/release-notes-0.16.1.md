Devcoin Core version 0.16.1 is now available from:

  <https://devcoin.org/bin/devcoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting devcoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure devcoind processes are cleaned up when tests end (sdaftuar)
