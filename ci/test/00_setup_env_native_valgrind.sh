...
export NO_DEPENDS=1
export TEST_RUNNER_EXTRA="--exclude rpc_bind"  # Excluded for now, see https://github.com/devcoin/core/issues/17765#issuecomment-602068547
export GOAL="install"
export DEVCOIN_CONFIG="--enable-zmq --with-incompatible-bdb --with-gui=no CC=clang CXX=clang++"  # TODO enable GUI
