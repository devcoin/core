...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/Devcoin
else
  DOCKER_EXEC echo \> \$HOME/.devcoin
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/devcoin/core/pull/18288#discussion_r433189350 for
  # details.
