...
The Devcoin Core project operates an open contributor model where anyone is
welcome to contribute towards development in the form of peer review, testing
and patches. This document explains the practical process and guidelines for
contributing.

First, in terms of structure, there is no particular concept of "Devcoin Core
...
Before you start contributing, familiarize yourself with the Devcoin Core build
system and tests. Refer to the documentation in the repository on how to build
Devcoin Core and how to run the unit tests, functional tests, and fuzz tests.

There are many open issues of varying difficulty waiting to be fixed.
If you're looking for somewhere to start contributing, check out the
[good first issue](https://github.com/devcoin/core/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list or changes that are
[up for grabs](https://github.com/devcoin/core/issues?utf8=%E2%9C%93&q=label%3A%22Up+for+grabs%22).
Some of them might no longer be applicable. So if you are interested, but
unsure, you might want to leave a comment on the issue first.

You may also participate in the weekly
[Devcoin Core PR Review Club](https://devcoincore.reviews/) meeting.
...
Most communication about Devcoin Core development happens on IRC, in the
`#devcoin-core-dev` channel on Libera Chat. The easiest way to participate on IRC is
with the web client, [web.libera.chat](https://web.libera.chat/#devcoin-core-dev). Chat
history logs can be found
on [http://www.erisian.com.au/devcoin-core-dev/](http://www.erisian.com.au/devcoin-core-dev/)
and [http://gnusha.org/devcoin-core-dev/](http://gnusha.org/devcoin-core-dev/).

Discussion about codebase improvements happens in GitHub issues and pull
requests.

The developer
[mailing list](https://lists.linuxfoundation.org/mailman/listinfo/devcoin-dev)
...
For GUI-related issues or pull requests, the https://github.com/devcoin-core/gui repository should be used.
For all other issues and pull requests, the https://github.com/devcoin/core node repository should be used.
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to devcoin-qt
...
fork of Devcoin Core copies the merge. Instead, make any username mentions in a
subsequent comment to the PR.

### Translation changes

Note that translations should not be submitted as pull requests. Please see
[Translation Process](https://github.com/devcoin/core/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Devcoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Devcoin
Network Protocol consensus changes.

Whether a pull request is merged into Devcoin Core rests with the project merge
...
Patches that change Devcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Devcoin consensus, it must have been
...
https://github.com/devcoin/core/pull/16189).

Also see the [backport.py script](
https://github.com/devcoin-core/devcoin-maintainer-tools#backport).
