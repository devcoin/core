// Copyright (c) 2018-2021 The Bitcoin Core and Devcoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef DEVCOIN_EXTERNAL_SIGNER_H
#define DEVCOIN_EXTERNAL_SIGNER_H
...
#endif // DEVCOIN_EXTERNAL_SIGNER_H
