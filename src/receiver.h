	...
	if (stepText == string())
	{
		if (stepFileName == string("receiver_0.csv"))
		{
			...
			peerText += string("http://devcoin.darkgamex.ch/receiver.csv\n");
                        ...
                        peerText += string("http://node2.devcoin.cloud/receiver_files/receiver.csv\n");
                        peerText += string("http://node3.devcoin.cloud/receiver_files/receiver.csv\n");
                        peerText += string("http://receivers.devcoinresource.com/receiver_files/receiver.csv\n");
