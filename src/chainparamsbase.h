...
#ifndef DEVCOIN_CHAINPARAMSBASE_H
#define DEVCOIN_CHAINPARAMSBASE_H
...
/**
 * CBaseChainParams defines the base parameters (shared between devcoin-cli and devcoind)
 * of a given instance of the Devcoin system.
 */
...
#endif // DEVCOIN_CHAINPARAMSBASE_H
