...
#ifndef DEVCOIN_WALLET_ISMINE_H
#define DEVCOIN_WALLET_ISMINE_H
 ...
 * https://github.com/devcoin/core/blob/master/doc/release-notes/release-notes-0.21.0.md#ismine-semantics
