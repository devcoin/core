...
#ifndef DEVCOIN_WALLET_WALLET_H
#define DEVCOIN_WALLET_WALLET_H
...
//! -fallbackfee default
static const CAmount DEFAULT_FALLBACK_FEE = 1 * COIN;
//! -discardfee default
static const CAmount DEFAULT_DISCARD_FEE = 10000;
//! -mintxfee default
static const CAmount DEFAULT_TRANSACTION_MINFEE = 5 * COIN;
/**
...
//! -maxtxfee default
// DEVCOIN
// See: https://github.com/devcoin/core/issues/100
constexpr CAmount DEFAULT_TRANSACTION_MAXFEE{1000 * COIN};
//! Discourage users to set fees higher than this amount (in satoshis) per kB
constexpr CAmount HIGH_TX_FEE_PER_KB{10 * COIN};
//! -maxtxfee will warn if called with a higher fee than this amount (in satoshis)
constexpr CAmount HIGH_MAX_TX_FEE{HIGH_TX_FEE_PER_KB * 10};
