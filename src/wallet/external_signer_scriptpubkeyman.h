...
#ifndef DEVCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define DEVCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // DEVCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
