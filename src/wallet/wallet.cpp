...
CWalletTx* CWallet::AddToWallet(CTransactionRef tx, const CWalletTx::Confirmation& confirm, const UpdateWalletTxFn& update_wtx, bool fFlushOnClose)
{
    ...
    if (!strCmd.empty())
    {
        ...
        // https://github.com/devcoin/core/pull/13339#issuecomment-537384875
        // A few ways it could be implemented in the future are described in:
        // https://github.com/devcoin/core/pull/13339#issuecomment-461288094
...
void CWallet::transactionRemovedFromMempool(const CTransactionRef& tx, MemPoolRemovalReason reason, uint64_t mempool_sequence) {
    ...
    if (reason == MemPoolRemovalReason::CONFLICT) {
        ...
        //    https://github.com/devcoin/core/pull/18600#discussion_r420195993.
        ...
        //    https://github.com/devcoin/core/pull/9371 and the prior sync
        ...
        // https://github.com/devcoin-core/devcoin-devwiki/wiki/Wallet-Transaction-Conflict-Tracking
        SyncTransaction(tx, {CWalletTx::Status::UNCONFIRMED, /* block height */ 0, /* block hash */ {}, /* index */ 0});
    }
}
 ...
 * https://devcointalk.org/?topic=54527, or
 * https://github.com/devcoin/core/pull/1393.
 */
...
int CWalletTx::GetBlocksToMaturity() const
{
    ...
    return std::max(0, (COINBASE_MATURITY+20) - chain_depth);
}
