...
#ifndef DEVCOIN_WALLET_WALLETUTIL_H
#define DEVCOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! devcoin from opening the wallet, thinking it was newly created, and
...
#endif // DEVCOIN_WALLET_WALLETUTIL_H
