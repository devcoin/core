...
#ifndef DEVCOIN_WALLET_SCRIPTPUBKEYMAN_H
#define DEVCOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Devcoin Core wallet was originally a collection of unrelated private
...
#endif // DEVCOIN_WALLET_SCRIPTPUBKEYMAN_H
