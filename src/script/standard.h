...
#ifndef DEVCOIN_SCRIPT_STANDARD_H
#define DEVCOIN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a devcoin address
 */
...
/**
 * Generate a Devcoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // DEVCOIN_SCRIPT_STANDARD_H
