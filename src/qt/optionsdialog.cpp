    ...
    mapper(nullptr)
{
    ...
    ui->devcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->devcoinAtStartup);
    ...
    ui->devcoinAtStartup->setToolTip(ui->devcoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->devcoinAtStartup->setText(ui->devcoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openDevcoinConfButton->setToolTip(ui->openDevcoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new DevcoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->devcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openDevcoinConfButton_clicked()
{
