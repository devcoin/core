...
#ifndef DEVCOIN_QT_OPTIONSMODEL_H
#define DEVCOIN_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Devcoin client.
...
#endif // DEVCOIN_QT_OPTIONSMODEL_H
