...
#ifndef DEVCOIN_QT_GUIUTIL_H
#define DEVCOIN_QT_GUIUTIL_H
...
/** Utility functions used by the Devcoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "devcoin:" URI into recipient object, return true on successful parsing
