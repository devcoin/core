...
#ifndef DEVCOIN_QT_RECEIVECOINSDIALOG_H
#define DEVCOIN_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of devcoins */
...
#endif // DEVCOIN_QT_RECEIVECOINSDIALOG_H
