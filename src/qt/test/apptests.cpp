...
//! Entry point for DevcoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &DevcoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for DevcoinGUI tests.
void AppTests::guiTests(DevcoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &DevcoinGUI::consoleShown, this, &AppTests::consoleTests);
