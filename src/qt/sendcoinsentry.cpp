    ...
    platformStyle(_platformStyle)
{
    ...
    // normal devcoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying devcoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &DevcoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
