...
public:
    CMainParams() {
        ...
        consensus.CSVHeight = 1118000;
        consensus.SegwitHeight = 1118000;
        ...
        genesis = CreateGenesisBlock(1311305081, 3085127155, 0x1d00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0000000062558fec003bcbf29e915cddfc34fa257dc87573f28e4520d1c7c11e"));
        assert(genesis.hashMerkleRoot == uint256S("0xe61339a40aa4e90e983fe0d64cf09eed5fa1e6eac227b6761f06ac7af1929baf"));
        ...
        vSeeds.emplace_back("seed01.devcoin.org");
        vSeeds.emplace_back("seed02.devcoin.org");
        vSeeds.emplace_back("seed03.devcoin.org");
        vSeeds.emplace_back("seed04.devcoin.org");
        ...
        checkpointData = {
            {
                {  2500, uint256S("0x000000001871a2314936d39b85174cc911bf6fd58d3877412ee7b69a48e7e29e")},
                {  4500, uint256S("0x000000000967cc95711f66f804e3f431298686d681d2d5760f61856954d08faf")},
                {  5250, uint256S("0x00000000085702bfbf27daffb638be65aceb78a5f464b12539b51c1b9c548421")},
                {  8900, uint256S("0x00000000001bb8090630fcabb82ad0ab75df3eb5b008956b3ae2a352a4324f19")},
                { 23500, uint256S("0x000000000b83c3c9753d2440b91121cb0ff220bb23c136c6d09a539207e292fb")},
                { 54800, uint256S("0x04e8dcc91ff2aa0f1197f88551b4cb24ccef02ea51081b4d05ab4e3a38554137")},
                { 67720, uint256S("0x0a111b265d89f77b4c86fa6f44e3e2ad876547b1eccf19319cde922b42c1161e")},
            }
        };
        ...
        chainTxData = ChainTxData{
            // Data from RPC: getchaintxstats 4096 e5f6dbecef5f5b8c49b8a6b7cefc80183dace19c474264b87f07edf55d347860
            /* nTime    */ 1639302651,
            /* nTxCount */ 709587,
            /* dTxRate  */ 0.001463829474125098,
        };
    }
};
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed01.devcoin.org");
        vSeeds.emplace_back("testnet-seed02.devcoin.org");
        ...
        checkpointData = {
            {
                {0, uint256S("0x00000000fc09a99bd5116e9cedcad35d2145962799e58bbfd66ebdeb4e95235f")},
            }
        };
...
public:
    explicit SigNetParams(const ArgsManager& args) {
        ...
        if (!args.IsArgSet("-signetchallenge")) {
            ...
            vSeeds.emplace_back("signet-seed01.devcoin.org");
            vSeeds.emplace_back("signet-seed02.devcoin.org");

            // TODO: Create genesis block for Signet
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x4b26872207bc3de8b1ad8786c155cb8c8f9a229a9f87597d5817384d72ca9595"));
        assert(genesis.hashMerkleRoot == uint256S("0xe61339a40aa4e90e983fe0d64cf09eed5fa1e6eac227b6761f06ac7af1929baf"));
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x734c2911bc3e664eb291150d060680534e0048ed99a26fc2bbe387dd65c4b0a8"));
        assert(genesis.hashMerkleRoot == uint256S("0xe61339a40aa4e90e983fe0d64cf09eed5fa1e6eac227b6761f06ac7af1929baf"));
