...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed.devcoin.sipa.be"); // Pieter Wuille, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("dnsseed.bluematt.me"); // Matt Corallo, only supports x9
        vSeeds.emplace_back("dnsseed.devcoin.dashjr.org"); // Luke Dashjr
        vSeeds.emplace_back("seed.devcoinstats.com"); // Christian Decker, supports x1 - xf
        vSeeds.emplace_back("seed.devcoin.jonasschnelli.ch"); // Jonas Schnelli, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.dvc.petertodd.org"); // Peter Todd, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.devcoin.sprovoost.nl"); // Sjors Provoost
        vSeeds.emplace_back("dnsseed.emzy.de"); // Stephan Oeste
        vSeeds.emplace_back("seed.devcoin.wiz.biz"); // Jason Maurice
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.devcoin.jonasschnelli.ch");
        vSeeds.emplace_back("seed.tdvc.petertodd.org");
        vSeeds.emplace_back("seed.testnet.devcoin.sprovoost.nl");
