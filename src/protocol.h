...
#ifndef DEVCOIN_PROTOCOL_H
#define DEVCOIN_PROTOCOL_H
...
/**
 * Devcoin protocol message types. When adding new message types, don't forget
...
enum ServiceFlags : uint64_t {
    ...
    // set by all Devcoin Core non pruned nodes, and is unset by SPV clients or other light clients.
    NODE_NETWORK = (1 << 0),
    // NODE_BLOOM means the node is capable and willing to handle bloom-filtered connections.
    // Devcoin Core nodes used to support this by default, without advertising this bit,
    ...
    // devcoin-development mailing list. Remember that service bits are just
