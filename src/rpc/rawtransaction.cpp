...
{
    // Call into TxToUniv() in devcoin-common to decode the transaction hex.
    //
    // Blockchain contextual information (confirmations and blocktime) is not
    // available to code in devcoin-common, so we query them here and push the
                             ...
                             {RPCResult::Type::ARR, "vout", "",
                             {
                                 {RPCResult::Type::OBJ, "", "",
                                 {
                                     ...
                                     {RPCResult::Type::OBJ, "scriptPubKey", "",
                                     {
                                         ...
                                         {RPCResult::Type::STR, "address", /* optional */ true, "devcoin address (only if a well-defined address exists)"},
                                         {RPCResult::Type::ARR, "addresses", /* optional */ true, "(DEPRECATED, returned only if config option -deprecatedrpc=addresses is passed) Array of devcoin addresses",
                                         {
                                             {RPCResult::Type::STR, "address", "devcoin address"},
                                         }},
                                     }},
                                 }},
                             }},
...
static RPCHelpMan decodepsbt()
{
    return RPCHelpMan{"decodepsbt",
                "\nReturn a JSON object representing the serialized, base64-encoded partially signed Devcoin transaction.\n",
                {
                            ...
                            {RPCResult::Type::OBJ, "", "",
                            {
                                ...
                                {RPCResult::Type::OBJ, "witness_utxo", /* optional */ true, "Transaction output for witness UTXOs",
                                {
                                    ...
                                    {RPCResult::Type::OBJ, "scriptPubKey", "",
                                    {
                                        ...
                                        {RPCResult::Type::STR_HEX, "hex", "The hex"},
                                        {RPCResult::Type::STR, "type", "The type, eg 'pubkeyhash'"},
                                        {RPCResult::Type::STR, "address"," Devcoin address if there is one"},
                                    }},
                                }},
...
static RPCHelpMan combinepsbt()
{
    return RPCHelpMan{"combinepsbt",
                "\nCombine multiple partially signed Devcoin transactions into one transaction.\n"
