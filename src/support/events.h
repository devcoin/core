// Copyright (c) 2016-2018 The Bitcoin Core and Devcoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef DEVCOIN_SUPPORT_EVENTS_H
#define DEVCOIN_SUPPORT_EVENTS_H
...
#endif // DEVCOIN_SUPPORT_EVENTS_H
