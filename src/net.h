...
#ifndef DEVCOIN_NET_H
#define DEVCOIN_NET_H
...
static const unsigned int MAX_PROTOCOL_MESSAGE_LENGTH = 12 * 1000 * 1000;
 ...
 * src/qt/guiutil.cpp and src/devcoin-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Devcoin’s Peer-to-Peer Network")
