...
{
    BOOST_CHECK(TestSplitHost("www.devcoin.org", "www.devcoin.org", 0));
    BOOST_CHECK(TestSplitHost("[www.devcoin.org]", "www.devcoin.org", 0));
    BOOST_CHECK(TestSplitHost("www.devcoin.org:80", "www.devcoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.devcoin.org]:80", "www.devcoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("127.0.0.1:52333", "127.0.0.1", 52333));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:52333", "127.0.0.1", 52333));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:52333", "::ffff:127.0.0.1", 52333));
    BOOST_CHECK(TestSplitHost("[::]:52333", "::", 52333));
    BOOST_CHECK(TestSplitHost("::52333", "::52333", 0));
    BOOST_CHECK(TestSplitHost(":52333", "", 52333));
    BOOST_CHECK(TestSplitHost("[]:52333", "", 52333));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:52333", "127.0.0.1:52333"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:52333", "[::]:52333"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
