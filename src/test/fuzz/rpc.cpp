...
const std::vector<std::string> RPC_COMMANDS_NOT_SAFE_FOR_FUZZING{
    ...
    "analyzepsbt",    // avoid signed integer overflow in CFeeRate::GetFee(unsigned long) (https://github.com/devcoin/core/issues/20607)
    ...
    "prioritisetransaction", // avoid signed integer overflow in CTxMemPool::PrioritiseTransaction(uint256 const&, long const&) (https://github.com/devcoin/core/issues/20626)
