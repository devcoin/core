...
#ifndef DEVCOIN_TEST_SCRIPTNUM10_H
#define DEVCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Devcoin Core 0.10.0, for cross-comparison.
 */
public:
