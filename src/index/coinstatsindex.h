// Copyright (c) 2020-2021 The Bitcoin Core and Devcoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef DEVCOIN_INDEX_COINSTATSINDEX_H
#define DEVCOIN_INDEX_COINSTATSINDEX_H
...
#endif // DEVCOIN_INDEX_COINSTATSINDEX_H
