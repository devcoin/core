...
#ifndef DEVCOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define DEVCOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@devcoin.
 *
 ...
 *
 * The chacha20-poly1305@devcoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@devcoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@devcoin are relatively fast in
...
#endif // DEVCOIN_CRYPTO_CHACHA_POLY_AEAD_H
