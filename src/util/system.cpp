...
// For details see https://github.com/devcoin/core/pull/22348.
...
const char * const DEVCOIN_CONF_FILENAME = "devcoin.conf";
const char * const DEVCOIN_SETTINGS_FILENAME = "settings.json";
 ...
 * https://github.com/devcoin/core/pull/16097#issuecomment-514627823
 */
...
bool ArgsManager::ParseParameters(int argc, const char* const argv[], std::string& error)
{
    ...
    for (int i = 1; i < argc; i++) {
        ...
        if (key == "-") break; //devcoin-tx using stdin
        std::string val;
...
bool ArgsManager::GetSettingsPath(fs::path* filepath, bool temp) const
{
    ...
    if (filepath) {
        std::string settings = GetArg("-settings", DEVCOIN_SETTINGS_FILENAME);
...
{
    // Windows: C:\Users\Username\AppData\Roaming\Devcoin
    // macOS: ~/Library/Application Support/Devcoin
    // Unix-like: ~/.devcoin
#ifdef WIN32
    // Windows
...
bool ArgsManager::ReadConfigFiles(std::string& error, bool ignore_invalid_keys)
{
    ...
    const std::string confPath = GetArg("-conf", DEVCOIN_CONF_FILENAME);
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    // Make sure Devcoin Core copyright is not removed by accident
    if (copyright_devs.find("Devcoin Core") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The Bitcoin Core and Devcoin Core developers";
    }
