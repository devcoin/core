 ...
 */
#ifndef DEVCOIN_UTIL_SYSTEM_H
#define DEVCOIN_UTIL_SYSTEM_H
...
extern const char * const DEVCOIN_CONF_FILENAME;
extern const char * const DEVCOIN_SETTINGS_FILENAME;
