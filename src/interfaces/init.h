...
#ifndef DEVCOIN_INTERFACES_INIT_H
#define DEVCOIN_INTERFACES_INIT_H
...
//! (devcoin-gui, devcoin-node, devcoin-wallet, devcoind, devcoin-qt) and each
...
#endif // DEVCOIN_INTERFACES_INIT_H
