...
#ifndef DEVCOIN_INTERFACES_NODE_H
#define DEVCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a devcoin node (devcoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // DEVCOIN_INTERFACES_NODE_H
