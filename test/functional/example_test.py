...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the DevcoinTestFramework
    pass


class ExampleTest(DevcoinTestFramework):
    # Each functional test is a subclass of the DevcoinTestFramework class.
    ...
    def custom_method(self):
        ...
        DevcoinTestFramework class so other tests can use it."""
