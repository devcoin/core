...
By default, devcoind will dump mempool on shutdown and
...
class MempoolPersistTest(DevcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent devcoind from writing mempool.dat to disk. Verify that `savemempool` fails")
