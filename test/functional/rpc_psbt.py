...
class PSBTTest(DevcoinTestFramework):
    ...
    def run_test(self):
        # Create and fund a raw tx for sending 10 DVC
        ...
        self.log.info("Test walletcreatefundedpsbt fee rate of 10000 sat/vB and 0.1 DVC/kvB produces a total fee at or slightly below -maxtxfee (~0.05290000)")
