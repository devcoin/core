...
# The block reward of coinbaseoutput.nValue (50) DVC/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 DVC/block.
...
class TestDevcoinCli(DevcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `devcoin-cli getblockchaininfo`")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and devcoin-cli getwalletinfo return expected wallet info")
            ...
            # Mine a block to confirm; adds a block reward (50 DVC) to the default wallet.
            ...
            # Test devcoin-cli -generate with -rpcwallet in multiwallet mode.
