...
class TestShell:
    """Wrapper Class for DevcoinTestFramework.

    The TestShell class extends the DevcoinTestFramework
    ...
    class __TestShell(DevcoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by DevcoinTestFramework child class.
            self.num_nodes = 1
