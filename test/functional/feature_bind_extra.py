#!/usr/bin/env python3
# Copyright (c) 2014-2021 The Bitcoin Core and Devcoin Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""
Test starting devcoind with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(DevcoinTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that devcoind has bound on "::1" (for RPC) and "::" (for P2P).
