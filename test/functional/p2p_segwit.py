...
class SegWitTest(DevcoinTestFramework):
    ...
    def test_p2sh_witness(self):
        ...
        # segwit activation.  Note that older devcoind's that are not
    ...
    def test_submit_block(self):
        ...
        # Now redo commitment with the standard nonce, but let devcoind fill it in.
