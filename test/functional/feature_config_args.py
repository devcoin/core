...
class ConfArgsTest(DevcoinTestFramework):
    ...
    def test_config_file_parser(self):
        ...
        with open(os.path.join(self.nodes[0].datadir, 'devcoin.conf'), 'a', encoding='utf-8') as conf:
        ...
        main_conf_file_path = os.path.join(self.options.tmpdir, 'node0', 'devcoin_main.conf')
    ...
    def run_test(self):
        ...
        conf_file = os.path.join(default_data_dir, "devcoin.conf")
