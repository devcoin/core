...
"""Verify that starting devcoin with -h works as expected."""

from test_framework.test_framework import DevcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(DevcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start devcoin with -h for help text")
        ...
        self.log.info("Start devcoin with -version for version information")
        ...
        self.log.info("Start devcoind with -fakearg to make sure it does not start")
