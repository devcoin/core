#!/usr/bin/env python3
# Copyright (c) 2021-2021 The Bitcoin Core and Devcoin Core developers
...
class I2PPorts(DevcoinTestFramework):
    ...
    def run_test(self):
        ...
        addr = "zsxwyo6qcn3chqzwxnseusqgsnuw3maqnztkiypyfxtya4snkoka.b32.i2p:52333"
        raised = False
        try:
