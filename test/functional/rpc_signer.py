#!/usr/bin/env python3
# Copyright (c) 2017-2018 The Bitcoin Core and Devcoin Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Test external signer.

Verify that a devcoind node can use an external signer command.
...
class RPCSignerTest(DevcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart devcoind with -signer=<cmd>',
