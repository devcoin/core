...
class P2PPermissionsTests(DevcoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].devcoinconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].devcoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
