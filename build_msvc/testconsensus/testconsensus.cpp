...
// devcoin includes.
#include <..\src\script\devcoinconsensus.h>
...
int main()
{
    std::cout << "devcoinconsensus version: " << devcoinconsensus_version() << std::endl;
    ...
    auto op0Result = devcoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, stream.data(), stream.size(), 0, devcoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
